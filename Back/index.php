...
<head lang="fr">
    ...
    <link rel="stylesheet" href="https://i.icomoon.io/public/temp/81dacc22d0/UntitledProject/style.css">
...
<body>
    ...
    <div id="menumain">
        ...
        <ul>
            ...
            <li><a href="http://Www.aribart-vincent.fr"><i class="icon-drop-05"></i>Propulsé par Syna.fr</a></li>
        </ul>
    </div>
    <div id="topbar">
