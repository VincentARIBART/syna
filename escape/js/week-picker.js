(function () {
    ...
    WeekPicker.prototype = {
        ...
        format:function (date) {
            ...
            return dom + "/" + month + '/' + date.getFullYear().toString().substr(2, 2);
        },
        ...
        nav:function (months) {
            var $subnav = $('<div>' +
                '<span class="prev button"><i class="icon-arrow-l"></i>Precedent</span> | ' +
                ' <span class="next button">Suivant<i class="icon-arrow-r"></i></span>' +
                '</div>');
    ...
    $(document).ready(function () {
        ...
        $.fn.weekpicker.defaults = {
            ...
            shortDayNames:["di", "lun", "mar", "mer", "jeu", "ven", "Sa"],
            week_start:1,
            months:1
        };
